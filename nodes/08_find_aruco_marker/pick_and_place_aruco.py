...
def get_object_tf_and_go():
    ...
    if lst.frameExists("/world") and lst.frameExists("marker_id1"):
        (translation, rotation) = lst.lookupTransform("base_link",
                                                      "marker_id1",
                                                      rospy.Time())
...
while not rospy.is_shutdown():
    try:
        ...
        (trans, rot) = lst.lookupTransform('/world', '/marker_id1', rospy.Time(0))
