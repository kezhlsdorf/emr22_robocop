...
input(" UR3 - Go to BlueGreyLego Position => Enter")
joint_goal = group.get_current_joint_values()
joint_goal[0] = np.deg2rad(-87)       # shoulder pan
joint_goal[1] = np.deg2rad(-57)      # shoulder lift
joint_goal[2] = np.deg2rad(74)      # elbow
joint_goal[3] = np.deg2rad(-102)     # wrist1
joint_goal[4] = np.deg2rad(-93)     # wrist2
joint_goal[5] = np.deg2rad(46)      # wrist3
...
joint_goal = group.get_current_joint_values()
joint_goal[0] = np.deg2rad(54)       # shoulder pan / Basis
joint_goal[1] = np.deg2rad(-94)       # shoulder lift / Schulter
joint_goal[2] = np.deg2rad(96)      # elbow
joint_goal[3] = np.deg2rad(-95)     # wrist1
joint_goal[4] = np.deg2rad(-92)     # wrist2
joint_goal[5] = np.deg2rad(4)      # wrist3
group.go(joint_goal, wait=True)
