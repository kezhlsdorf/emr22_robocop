...
int main(int argc, char** argv)
{
  ...
  // are used interchangably.
    static const std::string PLANNING_GROUP_ARM = "ur3_arm";
    ...
    // 1. Move to home position
      ...
      ROS_INFO_NAMED("tutorial", "Go home (pose goal) %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Current Pose x %f", current_pose.pose.position.x);
    ROS_INFO_NAMED("tutorial", "Current Pose y %f", current_pose.pose.position.y);
    ROS_INFO_NAMED("tutorial", "Current Pose z %f", current_pose.pose.position.z);
    
    ROS_INFO_NAMED("tutorial", "Current Orientation x %f", current_pose.pose.orientation.x);
    ROS_INFO_NAMED("tutorial", "Current Orientation y %f", current_pose.pose.orientation.y);
    ROS_INFO_NAMED("tutorial", "Current Orientation z %f", current_pose.pose.orientation.z);
    ROS_INFO_NAMED("tutorial", "Current Orientation w %f", current_pose.pose.orientation.w);
    ...
    ROS_INFO_NAMED("tutorial", " Go to this goal?  => y");
    char c;
    std::cin >> c;
    move_group_interface_arm.move();
