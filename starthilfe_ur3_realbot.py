...
class MainWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.myPb_gazebo_ur5.setText('Ur3_BringUP')
        self.myPb_gazebo_ur5.setGeometry(10, 90, 200, 40)  # x,y,w,h
        self.myPb_gazebo_ur5.clicked.connect(self.slot_ur3)

        # --- roslaunch ---
        self.myPb_gazebo_ur5 = QPushButton(self)
        self.myPb_gazebo_ur5.setText('MoveIt_BringUP')
        self.myPb_gazebo_ur5.setGeometry(220, 90, 200, 40)  # x,y,w,h
        self.myPb_gazebo_ur5.clicked.connect(self.slot_ur3_moveit)
        
        # --- roslaunch ---
        self.myPb_gazebo_ur5 = QPushButton(self)
        self.myPb_gazebo_ur5.setText('Cam_BringUP')
        self.myPb_gazebo_ur5.setGeometry(430, 90, 200, 40)  # x,y,w,h
        self.myPb_gazebo_ur5.clicked.connect(self.slot_ur3_cam)
        """
        # --- roslaunch ---
        self.myPb_gazebo_ur5 = QPushButton(self)
    ...
    def slot_ur3(self):
        os.system('gnome-terminal -- bash -c "roslaunch ur_robot_driver ur3_bringup.launch robot_ip:=192.168.1.1 target_filename:="${HOME}/ur3_robot_calibration.yaml; exec bash"')

    def slot_ur3_moveit(self):
        os.system('gnome-terminal -- bash -c "roslaunch ur3_gripper_moveit_config ur3_real_robot_emr22_moveit_bringup.launch; exec bash"')

    def slot_ur3_cam(self):
